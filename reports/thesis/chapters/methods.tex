...
raw player profiles are computed. This has two justifications: first, it puts the
data on the same scale; second, it controls for the changing landscape of the NBA by
